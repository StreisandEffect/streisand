...
* [Shadowsocks](http://shadowsocks.org/en/index.html)
  * La variante haute performance [variante libev](https://github.com/shadowsocks/shadowsocks-libev) est installée. Cette version est capable de gérer des milliers de connexions simultanées.
...
* [WireGuard](https://www.wireguard.io/)
  * Les utilisateurs Linux peuvent profiter d'un VPN de nouvelle génération qui est simple mais à la même fois moderne, basé sur le noyau, et incroyablement rapide.
  * En plus de la cryptographie asymétrique que WireGuard utilise par défaut, une clé prépartagée est également configurée pour aider à fournir une résistance post-quantique. Utilisez le VPN du futur avec un œil vers l'avenir!
