...
* [Shadowsocks](http://shadowsocks.org/en/index.html)
  ...
  * [simple-obfs](https://github.com/shadowsocks/simple-obfs) plugin is installed to have robust evasion through hostile networks (esp. implementing quality of service (QOS) throttling).
