...
- - -
[English](README.md), [Français](README-fr.md) [简体中文](README-zh.md)
- - -

[![构建的状况](https://travis-ci.org/jlund/streisand.svg?branch=master)](https://travis-ci.org/jlund/streisand)

Streisand
=========

**消音督察. [自动做效应](https://zh.wikipedia.org/wiki/%E5%8F%B2%E7%BF%A0%E7%8F%8A%E6%95%88%E5%BA%94).**

今天互联网是不公。目前把你的最喜欢的网站和信息，电讯公司，政客，大公司，都很容易阻碍联通。 突破这些条框*很难*，对吗？

介绍 Streisand
---------------------

* 录入只一指令就有个新开Ubuntu 16.04服务器服务[好多不等反督察软件](#services-provided)。这些软件可以完全伪装和加密互联网流量。

* 目前Streisand在[Amazon EC2](https://aws.amazon.com/ec2/), [Azure](https://azure.microsoft.com), [DigitalOcean](https://www.digitalocean.com/), [Google Compute Engine](https://cloud.google.com/compute/), [Linode](https://www.linode.com/), [Rackspace](https://www.rackspace.com/) 可以natively做实例。还是不管provider它也可以用任何Ubuntu 16.04服务器。随便你选的做法，你可以同时安装几百实例。
* 十分钟内做吧是自动手续玩。这个比等普通的系统管理员s手工做很快。
* 你的新开Streisand服务器开始后，你可以很容易发给你的家人，朋友们，同斗士们联接说明。 因为在说明里有附上embedded SSL certificate你只需要发一个文件。
* 在每个Streisand 服务器什么需要开使用都有。包括用加密核实最常用的客户应用。 这个让督察本来客户应用下载网站毫无效果。
* 还有很多。。。
